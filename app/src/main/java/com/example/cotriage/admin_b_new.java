...
public class admin_b_new extends AppCompatActivity {
    Button data,logout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_bnew);

        data = findViewById(R.id.button8);
        data.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), data_admin_b_new.class);
